                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade in active" id="diri" role="tabpanel" aria-labelledby="diri-tab">
                            <div class="row py-4">
                                <!-- pasfoto -->
                                <div class="col-4">
                                    <form action="<?= site_url('/bio/biodata/save_foto') ?>" enctype="multipart/form-data" role="form" method="POST">
                                        <div class="card">
                                            <div class="card-body">
                                ...
                                <!-- detail data pribadi -->
                                <div class="col-8">
                                    <form action="<?= site_url('/bio/biodata/save_pribadi') ?>" enctype="multipart/form-data" role="form" method="POST">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <div class="form-group px-2">
                                                        <label for="nama_lengkap">Nama Lengkap<span style="color: red;">*</span></label>
                                                        <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" placeholder="" value="<?php echo $biodata->nama_lengkap ?? '' ?>" required>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6 px-3">
                                                        <label for="nama_panggilan">Nama Panggilan<span style="color: red;">*</span></label>
                                                        <input type="text" class="form-control" id="nama_panggilan" name="nama_panggilan" placeholder="" value="<?php echo $biodata->nama_panggilan ?? '' ?>" required>
                                                        </div>
                                                        <div class="form-group col-md-6 px-3">
                                                        <label for="ktp">No. KTP<span style="color: red;">*</span></label>
                                                        <input type="text" class="form-control" id="ktp" name="ktp" placeholder="" value="<?php echo $biodata->ktp ?? '' ?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6 px-3">
                                                        <label for="nrp">NRP<span style="color: red;">*</span></label>
                                                        <input type="text" class="form-control" id="nrp" name="nrp" placeholder="" value="<?php echo $biodata->nrp ?? '' ?>" required>
                                                        </div>
                                                        <div class="form-group col-md-6 px-3">
                                                        <label for="angkatan">Angkatan<span style="color: red;">*</span></label>
                                                        <input type="text" class="form-control" id="angkatan" name="angkatan" placeholder="" value="<?php echo $biodata->angkatan ?? '' ?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6 px-3">
                                                        <label for="semester">Semester<span style="color: red;">*</span></label>
                                                        <input type="text" class="form-control" id="semester" name="semester" placeholder="" value="<?php echo $biodata->semester ?? '' ?>" required>
                                                        </div>
                                                        <div class="form-group col-md-6 px-3">
                                                        <label for="ipk">IPK<span style="color: red;">*</span></label>
                                                        <input type="text" class="form-control" id="ipk" name="ipk" placeholder="" value="<?php echo $biodata->ipk ?? '' ?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6 px-3">
                                                        <label for="no_telepon">No. Telepon<span style="color: red;">*</span></label>
                                                        <input type="text" class="form-control" id="no_telepon" name="no_telepon" placeholder="" value="<?php echo $biodata->no_telepon ?? '' ?>" required>
                                                        </div>
                                                        <div class="form-group col-md-6 px-3">
                                                        <label for="asal_sma">Asal SMA<span style="color: red;">*</span></label>
                                                        <input type="text" class="form-control" id="asal_sma" name="asal_sma" placeholder="" value="<?php echo $biodata->asal_sma ?? '' ?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6 px-3">
                                                        <label for="ukt">UKT<span style="color: red;">*</span></label>
                                                        <input type="number" class="form-control" id="ukt" name="ukt" placeholder="" value="<?php echo $biodata->ukt ?? '' ?>" required>
                                                        </div>
                                                        <div class="form-group col-md-6 px-3">
                                                        <label for="nama_bank">Nama Bank<span style="color: red;">*</span></label>
                                                        <input type="text" class="form-control" id="nama_bank" name="nama_bank" placeholder="" value="<?php echo $biodata->nama_bank ?? '' ?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6 px-3">
                                                        <label for="nama_rekening">Nama Rekening<span style="color: red;">*</span></label>
                                                        <input type="text" class="form-control" id="nama_rekening" name="nama_rekening" placeholder="" value="<?php echo $biodata->nama_rekening ?? '' ?>" required>
                                                        </div>
                                                        <div class="form-group col-md-6 px-3">
                                                        <label for="no_rekening">No. Rekening<span style="color: red;">*</span></label>
                                                        <input type="text" class="form-control" id="no_rekening" name="no_rekening" placeholder="" value="<?php echo $biodata->no_rekening ?? '' ?>" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6 px-3">
                                                            ...
                                                            <input type="text" class="form-control" id="nama_beasiswa" name="nama_beasiswa" placeholder="" value="<?php echo $biodata->nama_beasiswa ?? '' ?>">
                                                        </div>
                                                        <div class="form-group col-md-6 px-3">
                                                            <label for="nilai_beasiswa">Nilai Beasiswa</label>
                                                            <input type="text" class="form-control" id="nilai_beasiswa" name="nilai_beasiswa" placeholder="" value="<?php echo $biodata->nilai_beasiswa ?? '' ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="tab-pane fade" id="ortu" role="tabpanel" aria-labelledby="ortu-tab">
                            <div class="row pt-4">
                                <div class="col-12">
                                    <form action="<?= site_url('/bio/biodata/save_ortu') ?>" enctype="multipart/form-data" role="form" method="POST">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="form-row">
                                                    <div class="form-group col-md-8">
                                                        <div class="form-group row px-3 py-2">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control" id="telepon_ortu" name="telepon_ortu" placeholder="" value="<?php echo $biodata->telepon_ortu ?? '' ?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row px-3 py-2">
                                                            <label for="pekerjaan_ortu" class="col-sm-4 col-form-label">Pekerjaan Orang Tua<span style="color: red;">*</span></label>
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control" id="pekerjaan_ortu" name="pekerjaan_ortu" placeholder="" value="<?php echo $biodata->pekerjaan_ortu ?? '' ?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row px-3 py-2">
                                                            <label for="penghasilan_ortu" class="col-sm-4 col-form-label">Penghasilan Orang Tua<span style="color: red;">*</span></label>
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control" id="penghasilan_ortu" name="penghasilan_ortu" placeholder="" value="<?php echo $biodata->penghasilan_ortu ?? '' ?>" required>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="tab-pane fade" id="rumah" role="tabpanel" aria-labelledby="rumah-tab">
                            <div class="row pt-4">
                                <div class="col-12">
                                    <form action="<?= site_url('/bio/biodata/save_rumah') ?>" enctype="multipart/form-data" role="form" method="POST">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="form-row">
                                                    <div class="form-group col-md-8">
                                                        <div class="form-group row px-3 py-2">
                                                            ...
                                                            <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="link_google_map" name="link_google_map" placeholder="" value="<?php echo $biodata->link_google_map ?? '' ?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row px-3 py-2">
                                                            <label for="status_rumah" class="col-sm-4 col-form-label">Status Rumah<span style="color: red;">*</span></label>
                                                            <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="status_rumah" name="status_rumah" placeholder="" value="<?php echo $biodata->status_rumah ?? '' ?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row px-3 py-2">
                        ...
                        <div class="tab-pane fade" id="cerita" role="tabpanel" aria-labelledby="cerita-tab">
                            <div class="row py-4">
                                <div class="col-12">
                                    <form action="<?= site_url('/bio/biodata/save_cerita') ?>" enctype="multipart/form-data" role="form" method="POST">
                                        <div class="card">
                                            <div class="card-body">                           
                                                <div class="form-group">
                                                    <div class="form-group row px-3 py-2">
                                                        ...
                                                        <div class="col-sm-8">
                                                        <textarea class="form-control" id="kegiatan_selain_kuliah" name="kegiatan_selain_kuliah" rows="3" placeholder="" required><?php echo $biodata->kegiatan_selain_kuliah ?? '' ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row px-3 py-2">
                                                        <label for="organisasi" class="col-sm-4 col-form-label">Organisasi yang (pernah) diikuti<span style="color: red;">*</span></label>
                                                        <div class="col-sm-8">
                                                        <textarea class="form-control" id="organisasi" name="organisasi" rows="3" placeholder="" required><?php echo $biodata->organisasi ?? '' ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row px-3 py-2">
                                                        ...
                                                        <div class="col-sm-8">
                                                        <textarea class="form-control" id="kehidupan_sehari_hari" name="kehidupan_sehari_hari" rows="3" placeholder="" required><?php echo $biodata->kehidupan_sehari_hari ?? '' ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row px-3 py-2">
                                                        <label for="cerita_keluarga" class="col-sm-4 col-form-label">Keluarga Anda<span style="color: red;">*</span></label>
                                                        <div class="col-sm-8">
                                                        <textarea class="form-control" id="cerita_keluarga" name="cerita_keluarga" rows="3" placeholder="" required><?php echo $biodata->cerita_keluarga ?? '' ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row px-3 py-2">
                                                        <label for="dampak_covid" class="col-sm-4 col-form-label">Dampak wabah COVID-19 yang dialami<span style="color: red;">*</span></label>
                                                        <div class="col-sm-8">
                                                        <textarea class="form-control" id="dampak_covid" name="dampak_covid" rows="3" placeholder="" required><?php echo $biodata->dampak_covid ?? '' ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row px-3 py-2">
                                                        ...
                                                        <div class="col-sm-8">
                                                        <textarea class="form-control" id="capaian_ke_depan" name="capaian_ke_depan" rows="3" placeholder="" required><?php echo $biodata->capaian_ke_depan ?? '' ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row px-3 py-2">
                                                        ...
                                                        <div class="col-sm-8">
                                                        <textarea class="form-control" id="ketika_menjadi_alumni" name="ketika_menjadi_alumni" rows="3" placeholder="" required><?php echo $biodata->ketika_menjadi_alumni ?? '' ?></textarea>
                                                        </div>
                                                    </div>
