                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-8">
                                                ...
                                                <div class="form-group row px-3 py-2">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input class="form-control-file <?php echo form_error('foto_rumah') ? 'is-invalid':'' ?>" type="file" name="foto_rumah" />
                                            ...
                                            <div class="form-group col-md-4 p-3">
                                                <p>Catatan :</p>                                
                                                <p>Bagian dengan (<span style="color: red;">*</span>) bersifat harus diisi</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer">
